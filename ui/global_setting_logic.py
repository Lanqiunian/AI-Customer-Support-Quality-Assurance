...
from utils.global_utils import GLOBAL_DB_PATH, USER_NAME, DEFAULT_AI_PROMPT, API_KEY, get_global_setting
...
class GlobalSettingPageLogic:
    ...
    def setup_global_setting(self):
        user_name, default_ai_prompt, ai_api_key = get_global_setting()
    ...
    def on_click_save_button(self):
        try:
            ...
            get_global_setting()
            print(USER_NAME, DEFAULT_AI_PROMPT, API_KEY)
