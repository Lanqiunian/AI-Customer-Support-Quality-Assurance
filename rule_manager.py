...
from basic_methods import Keywords_Matching, Regex_Matching, Script_Matching


class Rule:
    def __init__(self, rule_name, script_rules=None, keyword_rules=None, regex_rules=None):
        """
